...
TEST_CMDS = ["sudo chmod +w /var/log",
             ...
             "sudo /opt/cactus/bin/controlhub_stop",
             "DummyHardwareTcp.exe 50002 20 &> /dev/null &",
             "test_dummy_timeout.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.tcp",
             ...
             "test_dummy_multithreaded_shared_HwInterface.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.udp",
             "test_dummy_multithreaded_copied_HwInterface.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.udp",
             ...
             "test_dummy_multithreaded_shared_HwInterface.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.controlhub",
             "test_dummy_multithreaded_copied_HwInterface.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.controlhub",
             ...
             "sudo /opt/cactus/bin/controlhub_stop",
             #TCP TESTS
             "DummyHardwareTcp.exe 50002 &> /dev/null &",
             ...
             "test_dummy_multithreaded_shared_HwInterface.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.tcp",
             "test_dummy_multithreaded_copied_HwInterface.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.tcp",
