...
COMMANDS += [["TEST IPBUS 2.0",
             ...
             "sudo /opt/cactus/bin/controlhub_stop",
             #TIMEOUT TESTS
             "DummyHardwareUdp.exe --version 2 --port 50101 --delay 2 &> /dev/null &",
             ...
             "pkill -f \"DummyHardwareUdp.exe\"",
             "sudo /opt/cactus/bin/controlhub_stop",
             "DummyHardwareTcp.exe --version 2 --port 50102 --delay 2 &> /dev/null &",
             "test_dummy_timeout.exe -c file:///opt/cactus/etc/uhal/tests/dummy_connections.xml -d dummy.tcp2",
             "pkill -f \"DummyHardwareTcp.exe\"",
             #UDP TESTS
             "DummyHardwareUdp.exe --version 2 --port 50101 &> /dev/null &",
             "PerfTester.exe -t BandwidthTx -b 0x01 -w 1 -i 1000 -p -d ipbusudp-2.0://localhost:50101",
             "PerfTester.exe -t BandwidthTx -b 0x01 -w 262144 -i 1000 -p -d ipbusudp-2.0://localhost:50101",
             "PerfTester.exe -t BandwidthRx -b 0x01 -w 1 -i 1000 -p -d ipbusudp-2.0://localhost:50101",
             "PerfTester.exe -t BandwidthRx -b 0x01 -w 262144 -i 1000 -p -d ipbusudp-2.0://localhost:50101",
             ...
             "sudo /opt/cactus/bin/controlhub_start",
             "sudo /opt/cactus/bin/controlhub_status",
             "PerfTester.exe -t BandwidthTx -b 0x01 -w 1 -i 1000 -p -d chtcp-1.3://localhost:10203?target=localhost:50101",
             "PerfTester.exe -t BandwidthTx -b 0x01 -w 262144 -i 1000 -p -d chtcp-1.3://localhost:10203?target=localhost:50101",
             "PerfTester.exe -t BandwidthRx -b 0x01 -w 1 -i 1000 -p -d chtcp-1.3://localhost:10203?target=localhost:50101",
             "PerfTester.exe -t BandwidthRx -b 0x01 -w 262144 -i 1000 -p -d chtcp-1.3://localhost:10203?target=localhost:50101",
             ...
             "sudo /opt/cactus/bin/controlhub_stop",
             #TCP TESTS
             "DummyHardwareTcp.exe --version 2 --port 50102 &> /dev/null &",
             "PerfTester.exe -t BandwidthTx -b 0x01 -w 1 -i 1000 -p -d ipbustcp-1.3://localhost:50002",
             "PerfTester.exe -t BandwidthTx -b 0x01 -w 262144 -i 1000 -p -d ipbustcp-1.3://localhost:50002",
             "PerfTester.exe -t BandwidthRx -b 0x01 -w 1 -i 1000 -p -d ipbustcp-1.3://localhost:50002",
             "PerfTester.exe -t BandwidthRx -b 0x01 -w 262144 -i 1000 -p -d ipbustcp-1.3://localhost:50002",
