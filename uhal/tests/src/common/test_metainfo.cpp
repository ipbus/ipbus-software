...
UHAL_TESTS_DEFINE_CLIENT_TEST_CASES(NodeMetainfoTestSuite, check_meta_info, MinimalFixture,
{
  ...
  //REG_READ_ONLY
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_READ_ONLY" ).getAddress(), 0x0002u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_READ_ONLY" ).getSize(), 1u );
  ...
  //REG_WRITE_ONLY
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_WRITE_ONLY" ).getAddress(), 0x0003u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_WRITE_ONLY" ).getSize(), 1u );
  ...
  //REG_UPPER_MASK
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_UPPER_MASK" ).getAddress(), 0x0004u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_UPPER_MASK" ).getSize(), 1u );
  ...
  //REG_LOWER_MASK 
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_LOWER_MASK" ).getAddress(), 0x0004u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_LOWER_MASK" ).getSize(), 1u );
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_LOWER_MASK" ).getMask(), 0x0000FFFFu );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_MASKED_READ_ONLY" ).getAddress(), 0x0005u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_MASKED_READ_ONLY" ).getSize(), 1u );
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_MASKED_READ_ONLY" ).getMask(), 0xFFFF0000u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_MASKED_WRITE_ONLY" ).getAddress(), 0x0005u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_MASKED_WRITE_ONLY" ).getSize(), 1u );
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_MASKED_WRITE_ONLY" ).getMask(), 0x0000FFFFu );
  ...
  //REG_WITH_PARS
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_PARS" ).getAddress(), 0x0006u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_PARS" ).getSize(), 1u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "REG_PARS" ).getParameters().size(), 2u );
  ...
  //SUBSYSTEM1.REG
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM1.REG" ).getAddress(), 0x210002u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM1.REG" ).getSize(), 1u );
  ...
  //SUBSYSTEM2.REG
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM2.REG" ).getAddress(), 0x310002u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM2.REG" ).getSize(), 1u );
  ...
  //FIFO
  BOOST_CHECK_EQUAL ( hw.getNode ( "FIFO" ).getAddress(), 0x0100u );
  BOOST_CHECK_EQUAL ( hw.getNode ( "FIFO" ).getId(), "FIFO" );
  BOOST_CHECK_EQUAL ( hw.getNode ( "FIFO" ).getPermission(), uhal::defs::READWRITE );
  BOOST_CHECK_EQUAL ( hw.getNode ( "FIFO" ).getSize(), uint32_t(1024*1024*1024/4) );
  ...
  //MEM
  BOOST_CHECK_EQUAL ( hw.getNode ( "MEM" ).getAddress(), 0x100000u );
  BOOST_CHECK_EQUAL ( hw.getNode ( "MEM" ).getId(), "MEM" );
  BOOST_CHECK_EQUAL ( hw.getNode ( "MEM" ).getPermission(), uhal::defs::READWRITE );
  BOOST_CHECK_EQUAL ( hw.getNode ( "MEM" ).getSize(), uint32_t(1024*1024/4) );
  ...
  //SMALL_MEM
  BOOST_CHECK_EQUAL ( hw.getNode ( "SMALL_MEM" ).getAddress(), 0x400000u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "SMALL_MEM" ).getSize(), 256u );
  ...
  //LARGE_MEM
  BOOST_CHECK_EQUAL ( hw.getNode ( "LARGE_MEM" ).getAddress(), 0x500000u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "LARGE_MEM" ).getSize(), uint32_t(100*1024*1024/4) );
  ...
  //SUBSYSTEM1.MEM
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM1.MEM" ).getAddress(), 0x210003u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM1.MEM" ).getSize(), uint32_t(1024*1024/4) );
  ...
  //SUBSYSTEM2.MEM
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM2.MEM" ).getAddress(), 0x310003u );
  ...
  BOOST_CHECK_EQUAL ( hw.getNode ( "SUBSYSTEM2.MEM" ).getSize(), uint32_t(1024*1024/4) );
  ...
  BOOST_CHECK_EQUAL( lPars.size(), 3u );
  //SUBSYSTEM2
  ...
  BOOST_CHECK_EQUAL( lPars.size(), 4u );
