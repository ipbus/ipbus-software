...
namespace uhal
{
  ...
  class IPbus < 1 , IPbus_minor > : public IPbusCore
  {
    ...
    public:
      ...
      */
      static uint32_t CalculateHeader ( const eIPbusTransactionType& aType , const IPbusDataWidth aWidth , const uint32_t& aWordCount , const uint32_t& aTransactionId , const uint8_t& aInfoCode );
      ...
      /**
        ...
        @return an IPbus header
      */
      static uint32_t ExpectedHeader ( const eIPbusTransactionType& aType , const IPbusDataWidth aWidth , const uint32_t& aWordCount , const uint32_t& aTransactionId , const uint8_t& aInfoCode );
      ...
      */
      static bool ExtractHeader ( const uint32_t& aHeader , eIPbusTransactionType& aType , IPbusDataWidth& aWidth , uint32_t& aWordCount , uint32_t& aTransactionId , uint8_t& aInfoCode );
    ...
    protected:
      ...
      /**
        ...
        @return an IPbus header
      */
      uint32_t implementCalculateHeader ( const eIPbusTransactionType& aType , const IPbusDataWidth aWidth , const uint32_t& aWordCount , const uint32_t& aTransactionId , const uint8_t& aInfoCode );
      ...
      /**
        ...
        @return whether extraction succeeded
      */
      bool implementExtractHeader ( const uint32_t& aHeader , eIPbusTransactionType& aType , IPbusDataWidth& aWidth , uint32_t& aWordCount , uint32_t& aTransactionId , uint8_t& aInfoCode );
  ...
  class IPbus < 2 , IPbus_minor > : public IPbusCore
  {
    ...
    public:
      /**
        ...
        @return an IPbus header
      */
      static uint32_t CalculateHeader ( const eIPbusTransactionType& aType , const IPbusDataWidth aWidth , const uint32_t& aWordCount , const uint32_t& aTransactionId , const uint8_t& aInfoCode = 0 );
      ...
      /**
        ...
        @return an IPbus header
      */
      static uint32_t ExpectedHeader ( const eIPbusTransactionType& aType , const IPbusDataWidth aWidth , const uint32_t& aWordCount , const uint32_t& aTransactionId , const uint8_t& aInfoCode = 0 );
