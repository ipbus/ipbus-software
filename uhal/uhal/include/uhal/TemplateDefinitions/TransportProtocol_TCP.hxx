...
// TcpTransportProtocol::TcpTransportProtocol ( const std::string& aHostname , const std::string& aServiceOrPort /*, PACKINGPROTOCOL& aPackingProtocol , uint32_t aTimeoutPeriod*/ ) try :
// TransportProtocol(),
// mHostname ( aHostname ),
...
// void TcpTransportProtocol::Dispatch( std::deque< Buffers >::iterator& aBuffers )
// {
// try
// {
