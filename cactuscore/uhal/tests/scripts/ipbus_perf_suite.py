...
def measure_n_to_m_performance(targets, controlhub_ssh_client, n_meas, n_words):
    '''
...
def plot_n_to_m_performance(all_data):
    ...
    for data_subset in all_data:
        ...
        bw_stats       = bootstrap_stats_array( data_subset['bw'] )
