...
export LD_LIBRARY_PATH=$CACTUSCORE_DIR/boost/RPMBUILD/SOURCES/lib:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$CACTUSCORE_DIR/pugixml/RPMBUILD/SOURCES/lib:$LD_LIBRARY_PATH
...
export PYTHONPATH=$CACTUSCORE_UHAL_DIR/uhal/tools:$PYTHONPATH
