...
def get_commands(conn_file):
    ...
    cmds += [["TEST IPBUS2.0 CONTROLHUB with packet loss",
              [# Setup
               ...
               # Main tests 
               "PerfTester.exe -t BandwidthTx -b 0x01 -w 1   -i 400000 -p -d ipbustcp-2.0://localhost:60002",
               "PerfTester.exe -t BandwidthTx -b 0x01 -w 1   -i 400000 -p -d ipbustcp-2.0://localhost:60002",
               "PerfTester.exe -t BandwidthTx -b 0x01 -w 1   -i 400000 -p -d ipbustcp-2.0://localhost:60002",
               "PerfTester.exe -t BandwidthTx -b 0x01 -w 1   -i 400000 -p -d chtcp-2.0://localhost:10203?target=localhost:60001",
               "PerfTester.exe -t BandwidthTx -b 0x01 -w 1   -i 400000 -p -d chtcp-2.0://localhost:10203?target=localhost:60001",
               "PerfTester.exe -t BandwidthTx -b 0x01 -w 1   -i 400000 -p -d chtcp-2.0://localhost:10203?target=localhost:60001",
               "controlhub_stats",
               "netstat -s --udp", "netstat -s --tcp",
