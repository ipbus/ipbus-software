...
BOOST_PYTHON_MODULE ( _core )
{
  ...
  .def ( "writeBlockOffset",static_cast<uhal::ValHeader ( uhal::Node::* ) ( const std::vector<uint32_t>&, const uint32_t &aOffset ) const> ( &uhal::Node::writeBlockOffset ) )
  ...
  .def ( "readBlockOffset", static_cast<uhal::ValVector<uint32_t> ( uhal::Node::* ) ( const uint32_t&, const uint32_t &aOffset ) const> ( &uhal::Node::readBlockOffset ) )
